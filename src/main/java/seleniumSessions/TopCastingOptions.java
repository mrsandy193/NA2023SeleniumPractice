...
public class TopCastingOptions {
	...
	public static void main(String[] args) {
		...
		// 1. browser specific: Valid. can not be used for the cross browser
		...
		// 3. SC = new CD() - valid but not recommended (Only SearchContext methods can be accessed)
		...
		// 6. SC = new RWD(); - valid but not recommended (Only SearchContext methods can be accessed)
